(function () {
    ...
    Scaff.serializeUser = function(user, done) {
		debug('default serializeUser: ' + JSON.stringify(user));
		done(null, user);
	}

	Scaff.deserializeUser = deserializeUserMysql
    Scaff.deserializeUserMysql = deserializeUserMysql
    ...
    Scaff.clearUsersOtherSessions = function clearUsersOtherSessions(req, res, next) {
    ...
    Scaff.clearUsersRememberMe = clearUsersRememberMe
    ...
    Scaff.redisUserSessionsKey = redisUserSessionsKey
    function redisUserSessionsKey(id){
        return 'user_sessions-' + id;
    }
    Scaff.redisUserRememberMeKey = redisUserRememberMeKey
    function redisUserRememberMeKey(id){
        return 'user_remember_me-' + id;
    }
    Scaff.redisRememberMeKey = redisRememberMeKey
